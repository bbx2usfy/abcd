...
def train(modelConfig: Dict):
    ...
    src = "/home/GAKER/GAKer-main/Source images dataset"
    src_target = "/home/GAKER/GAKer-main/Target images dataset"

    train_set = torchvision.datasets.ImageFolder(src, train_transform)
    target_set = torchvision.datasets.ImageFolder(src_target, target_transform )
    ...
    if modelConfig["Source_Model"] == "ResNet50": 
        ...
        feature_extraction = torch.nn.DataParallel(feature_extraction).to(device)
    ...
    for e in range(modelConfig["epoch"]):
        ...
        if (e+1)%1==0:
            torch.save(generator.module.state_dict(), os.path.join(modelConfig["Generator_save_dir"], 'ckpt_' + str(e) + "_" + modelConfig["Source_Model"] +"_.pt"))
    time_end = time.time()
